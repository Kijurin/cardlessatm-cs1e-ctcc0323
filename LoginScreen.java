...
public class LoginScreen extends JFrame {
    ...
    public LoginScreen() {
        ...
        gbc.insets = new Insets(20, 20, 20, 20); // Insets for spacing
        ...
        backButton.setBackground(new Color(30, 144, 255)); // DodgerBlue background
    ...
    private boolean isValidInput(String input) {
        // Check if input is numeric (for phone number) or matches email format
